...
- className (string; default "react-pie-menu"): Defines the center radius. For example, 30px or 0 (no center). This prop is forwarded to the Center Component.
...
- radius (string; default "100px"): Defines pie menu's radius in CSS Unit. For example, 150px. `"""
    @_explicitize_args
    def __init__(self, children=None, className=Component.UNDEFINED, centerRadius=Component.UNDEFINED, centerX=Component.REQUIRED, centerY=Component.REQUIRED, hidden=Component.UNDEFINED, iconsize=Component.UNDEFINED, id=Component.REQUIRED, loading_state=Component.UNDEFINED, radius=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'className', 'centerRadius', 'centerX', 'centerY', 'hidden', 'iconsize', 'id', 'loading_state', 'radius']
        self._type = 'DashReactPieMenu'
        self._namespace = 'dash_react_pie_menu'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'className', 'centerRadius', 'centerX', 'centerY', 'hidden', 'iconsize', 'id', 'loading_state', 'radius']
